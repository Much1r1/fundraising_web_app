      ...
      <div className="container mx-auto max-w-md">
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-muted-foreground">
            Join our community of givers and change-makers
          </p>
        </div>
              ...
              <TabsContent value="signup" className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="phone" type="tel" placeholder="+254..." className="pl-10" />
                  </div>
                </div>
                ...
                <Button className="w-full bg-accent hover:bg-accent/90 shadow-accent" disabled={isLoading}>
                  Create Account
                </Button>
              </TabsContent>
            </Tabs>
